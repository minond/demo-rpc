...
func init() {
	proto.RegisterType((*Friend)(nil), "friends.Friend")
	proto.RegisterType((*Ack)(nil), "friends.Ack")
	proto.RegisterType((*SearchRequest)(nil), "friends.SearchRequest")
}
...
func (c *friendsClient) Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (Friends_SearchClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Friends_serviceDesc.Streams[0], c.cc, "/friends.Friends/Search", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *friendsClient) Create(ctx context.Context, opts ...grpc.CallOption) (Friends_CreateClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Friends_serviceDesc.Streams[1], c.cc, "/friends.Friends/Create", opts...)
	if err != nil {
		return nil, err
	}
...
var fileDescriptor0 = []byte{
	...
	,
}
